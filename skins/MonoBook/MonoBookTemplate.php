...
class MonoBookTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		<div id="right-column" style="position: absolute; background-color: #FFF; top: 36px; right: 0px; width: 250px; background-color: #f1f1f1; z-index: 99; border-color: #aaa; border-style: solid; border-width: 1px; padding-left: 25px">
...
$html = $psr->parse('<categorytree mode=all>Kategorie:Hauptkategorie</categorytree>', $wgTitle, $opt, true, true)->getText();
echo $html;
