...
CREATE TABLE IF NOT EXISTS mw_flaggedpages (
...
CREATE TABLE IF NOT EXISTS mw_flaggedrevs (
  -- Foreign key to page.page_id
...
CREATE TABLE IF NOT EXISTS mw_flaggedpage_config (
  -- Foreign key to page.page_id
...
CREATE TABLE IF NOT EXISTS mw_flaggedtemplates (
...
CREATE TABLE IF NOT EXISTS mw_flaggedimages (
...
CREATE TABLE IF NOT EXISTS mw_flaggedrevs_tracking (
...
CREATE TABLE IF NOT EXISTS mw_flaggedrevs_promote (
  -- Foreign key to user.user_id
...
CREATE TABLE IF NOT EXISTS mw_reader_feedback (
  -- Foreign key to revision.rev_id
...
CREATE TABLE IF NOT EXISTS mw_reader_feedback_history (
  -- Foreign key to page.page_id
...
CREATE TABLE IF NOT EXISTS mw_reader_feedback_pages (
  -- Foreign key to page.page_id
